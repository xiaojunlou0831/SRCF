...
Tensorflow Implementation of Neural Graph Collaborative Filtering (SRCF) model in:
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run SRCF.")
    ...
    parser.add_argument('--dataset', nargs='?', default='movie-lens100k',
                        help='Choose a dataset from {gowalla, yelp2018, amazon-book, movie-lens100k}')
    parser.add_argument('--dataset_1', nargs='?', default='movie_item_subg',
                        help='Choose a dataset from {gowalla, yelp2018, amazon-book, movie-lens100k}')
    parser.add_argument('--dataset_2', nargs='?', default='movie_user_subg',
                        help='Choose a dataset from {gowalla, yelp2018, amazon-book, movie-lens100k}')
